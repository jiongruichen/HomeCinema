...
namespace HomeCinema.Web.Controllers
{
    ...
    public class StocksController : ApiControllerBase
    {
        ...
        public StocksController(IEntityBaseRepository<Stock> stocksRepository, IEntityBaseRepository<Error> _errorsRepository, IUnitOfWork _unitOfWork) : base(_errorsRepository, _unitOfWork)
        {
